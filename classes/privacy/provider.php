...
/**
 * Privacy Subsystem implementation for tool_leeloolxp_hdsync.
 *
...
namespace tool_leeloolxp_hdsync\privacy;
...
/**
 * Provider implementation for tool_leeloolxp_hdsync.
 *
 */
...
\core_privacy\local\request\data_provider {
    ...
    public static function get_metadata(collection $collection): collection {
        ...
        $collection->add_external_location_link('leeloolxp_hdsync_client', $externalfields, 'privacy:metadata:leeloolxp_hdsync');
